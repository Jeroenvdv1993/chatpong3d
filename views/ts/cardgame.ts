...
import { Card} from "../../src/cardgame/card";
import { Field } from "../../src/cardgame/field";
import { SelectedCard } from "../../src/cardgame/selectedCard";
...
function updateUnorderedList(UL: HTMLElement | null, array: Card[]): void{
    if(UL !== null){
        ...
        for(let index: number = 0; index < array.length; index++){
            ...
            img.src = `/img/cardgame/c_${array[index].id}.jpg`;
